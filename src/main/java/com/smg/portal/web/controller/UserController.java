package com.smg.portal.web.controller;

import com.codahale.metrics.annotation.Timed;
import com.smg.portal.domain.Role;
import com.smg.portal.domain.User;
import com.smg.portal.repository.RoleRepository;
import com.smg.portal.repository.UserRepository;
import com.smg.portal.security.RoleConstants;
import com.smg.portal.service.UserService;
import com.smg.portal.web.controller.dto.ManagedUserDTO;
import com.smg.portal.web.controller.util.HeaderUtil;
import com.smg.portal.web.controller.util.PaginationUtil;
...
public class UserController {
    ...
    public ResponseEntity<User> createUser(@RequestBody User user) throws URISyntaxException {
        ...
        return ResponseEntity.created(new URI("/rest/users/" + result.getId()))
        ...
        return userRepository
            ...
            .map(user -> {
                ...
                managedUserDTO.getAuthorities().stream().forEach(
                    authority -> authorities.add(roleRepository.findOne(authority))
                );
    ...
    public ResponseEntity<List<ManagedUserDTO>> getAllUsers(Pageable pageable)
        ...
        HttpHeaders headers = PaginationUtil.generatePaginationHttpHeaders(page, "/rest/users");
    ...
    public ResponseEntity<ManagedUserDTO> getUser(@PathVariable String login) {
        ...
        return userService.getUserWithRolesByLogin(login)
